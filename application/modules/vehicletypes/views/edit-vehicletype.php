        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="" enctype="multipart/form-data" action="<?php echo base_url(); ?>vehicletypes/edit-vehicletype/<?php echo $editdata['vehicle_type_id'];?>">
                <div class="card-body">
                  <div class="form-group">
                    <label for="vehicle_type">Vehicle Type Name</label>
                    <input type="text" class="form-control" id="vehicle_type" name="vehicle_type" placeholder="Enter Course Name" value="<?php echo $editdata['vehicle_type']; ?>">
