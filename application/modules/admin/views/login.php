...
<div class="login-box">
  ...
  <div class="login-logo">
    <img src="<?php echo base_url();?><?php echo $settings['logo'];?>" style="width:360px">
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <div class="col-md-12 col-md-offset-12">
        <?php  if (isset($error_message)) {
            ?>
            <span class="login-box-msg" style="color:red;margin-left:60px"> <?php  echo $error_message; ?> </span><br>
        <?php } ?>
      </div>
